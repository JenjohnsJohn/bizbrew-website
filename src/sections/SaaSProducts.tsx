    ...
    >
      ...
      >
        <h2 className="font-display font-bold text-[clamp(44px,6vw,84px)] leading-[1.05] text-bizbrew-offwhite">
          <span className="headline-line block text-bizbrew-amber">SaaS</span>
          <span className="headline-line block">Products</span>
        </h2>
      </div>
      ...
      <div
        ref={bodyRef}
        className="absolute left-[56vw] top-[52vh] w-[34vw]"
      >
